...
def main() -> None:
    parser = argparse.ArgumentParser(description="D-Wave-v6-Tages-Replay")
    parser.add_argument(
    ...
    print(
        f"D-Wave v6 · {result.trading_date:%d.%m.%Y} · "
    ...
    if not result.orders:
        print("Keine Orders: Kein Setup hat alle v6-Bedingungen einschließlich Kostenhürde erfüllt.")

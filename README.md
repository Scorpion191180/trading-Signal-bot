...
Seit Modellversion 8 wird jeder Horizont von 5 bis 120 Minuten getrennt geschätzt und zusätzlich durch eine harte 75-Prozent-Freigabe geschützt. Die jüngste 1-/5-/15-Minuten-Preisbewegung erhält bei kurzen Horizonten mehr Gewicht als nachlaufende EMA-, OTT- und MACD-Werte; bei widersprüchlichen Komponenten sinkt die angezeigte Modellstärke. Ein Mikrotrend darf nur noch kaufen, wenn 5- und 15-Minuten-Prognose die Richtung bestätigen und der Gesamtscore mindestens 58 erreicht. Die sichtbare Prognoselinie verbindet den aktuellen L&S-Bid mit allen Zielpunkten, und der Chartbereich schließt Kerzen, Prognosepunkte und Unsicherheitszonen vollständig ein.

## Echte Vorwärtsprüfung

Während die App geöffnet ist, speichert sie höchstens eine unveränderliche Prognose pro Fünf-Minuten-Block und aktiver Kursquelle. Nach 5, 15, 30, 60 und 120 Minuten wird diese Prognose ausschließlich mit dem dann später eingetroffenen Kurs derselben Quelle bewertet. L&S- und Tradegate-Verläufe werden dabei nicht vermischt. Fehlende Zeitpunkte – etwa weil die App geschlossen war oder die Sitzung endete – werden nicht mit Kursen des nächsten Tages ersetzt.

Für die 75-Prozent-Freigabe werden die Ergebnisse strikt nach Zeit geteilt: Die älteren 60 Prozent bestimmen eine mögliche Mindest-Modellstärke; nur die späteren 40 Prozent dürfen diese Schwelle bestätigen. Beide Abschnitte benötigen jeweils mindestens 30 passende Fälle. Zusätzlich muss die untere 95-Prozent-Vertrauensgrenze mindestens 60 Prozent erreichen. Solange das nicht erfüllt ist, bleibt die Linie grau und heißt „Modelltest · keine Vorhersage“; solche Punkte werden weder grün noch rot als freigegebene Vorhersage gewertet. Eine kleine offene Raute markiert den Erstellungszeitpunkt, der größere Zielpunkt den ausgewählten späteren Horizont. Dadurch ist beispielsweise eine 60-Minuten-Prognose nicht mit einer um eine Stunde verspäteten Erstellung zu verwechseln. Für einen Richtungstreffer muss die Kursbewegung außerdem den beim Signal gespeicherten Geld-/Brief-Spread überwinden. Alte Prognosen werden bei späteren Strategieänderungen nicht nachträglich umgeschrieben.
